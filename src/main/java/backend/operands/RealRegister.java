...
public class RealRegister extends Register {
    ...
    public RealRegister(int r1, int offset) {
        switch (r1 + offset + 2) {
            ...
            case 8, 13 -> regType = REGTYPE.s10;
            case 9 -> regType = REGTYPE.a0;
            case 10 -> regType = REGTYPE.a5;
            case 14 -> regType = REGTYPE.s9;
            case 15 -> regType = REGTYPE.s8;
            case 16 -> regType = REGTYPE.s7;
            case 17 -> regType = REGTYPE.s6;
            ...
            case 23 -> regType = REGTYPE.s11;
            case 24 -> regType = REGTYPE.t6;
            case 25 -> regType = REGTYPE.t5;
            case 26 -> regType = REGTYPE.t4;
            case 27 -> regType = REGTYPE.t3;
            case 28 -> regType = REGTYPE.t2;
